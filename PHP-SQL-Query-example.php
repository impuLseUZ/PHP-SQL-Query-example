...
Заказ поступающий из телеграмм бота нужно было интегрировать к базе сайта интернет магазина на движке OpenCart 3.x и хранить поступающий заказ в отдельной таблице(orders_id)
